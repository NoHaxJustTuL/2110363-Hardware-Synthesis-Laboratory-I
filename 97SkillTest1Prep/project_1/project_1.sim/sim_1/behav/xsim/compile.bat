...
REM
REM Generated by Vivado on Mon Feb 09 21:29:14 +0700 2026
...
echo "xvlog --incr --relax -prj skilltest1TB_vlog.prj"
call xvlog  --incr --relax -prj skilltest1TB_vlog.prj -log xvlog.log
