...
#
# Script generated by Vivado on Mon Feb 16 23:04:52 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DataBuffer.sh
...
#
# Usage        : DataBuffer.sh
#                DataBuffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DataBuffer.sh [-rerun]
#                DataBuffer.sh [-reset_run]
#                DataBuffer.sh [-clean]
#                DataBuffer.sh [-reset_log]
#                DataBuffer.sh [-help]
#
...
# script info
echo -e "DataBuffer.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DataBuffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DataBuffer xil_defaultlib.DataBuffer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DataBuffer -key {Behavioral:sim_1:Functional:DataBuffer} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DataBuffer.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DataBuffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DataBuffer.sh [-help]\n\
Usage: DataBuffer.sh [-step]\n\
Usage: DataBuffer.sh [-lib_map_path]\n\
Usage: DataBuffer.sh [-rerun]\n\
Usage: DataBuffer.sh [-reset_run]\n\
Usage: DataBuffer.sh [-clean]\n\
Usage: DataBuffer.sh [-reset_log]\n\
Usage: DataBuffer.sh [-keep_index]\n\
Usage: DataBuffer.sh [-noclean_files]\n\n\
