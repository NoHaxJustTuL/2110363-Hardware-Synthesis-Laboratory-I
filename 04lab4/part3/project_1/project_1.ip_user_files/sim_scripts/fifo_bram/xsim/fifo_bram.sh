...
#
# Script generated by Vivado on Tue Feb 03 00:05:44 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_bram.sh
...
#
# Usage        : fifo_bram.sh
#                fifo_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_bram.sh [-rerun]
#                fifo_bram.sh [-reset_run]
#                fifo_bram.sh [-clean]
#                fifo_bram.sh [-reset_log]
#                fifo_bram.sh [-help]
#
...
# script info
echo -e "fifo_bram.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_bram xil_defaultlib.fifo_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_bram -key {Behavioral:sim_1:Functional:fifo_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_bram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_bram.sh [-help]\n\
Usage: fifo_bram.sh [-step]\n\
Usage: fifo_bram.sh [-lib_map_path]\n\
Usage: fifo_bram.sh [-rerun]\n\
Usage: fifo_bram.sh [-reset_run]\n\
Usage: fifo_bram.sh [-clean]\n\
Usage: fifo_bram.sh [-reset_log]\n\
Usage: fifo_bram.sh [-keep_index]\n\
Usage: fifo_bram.sh [-noclean_files]\n\n\
