...
#
# Script generated by Vivado on Mon Feb 02 22:01:54 +0700 2026
...
#                blk_mem_ram.sh [-rerun]
#                blk_mem_ram.sh [-reset_run]
#                blk_mem_ram.sh [-clean]
...
# script info
echo -e "blk_mem_ram.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_ram xil_defaultlib.blk_mem_ram xil_defaultlib.glbl -log elaborate.log
}
...
Usage: blk_mem_ram.sh [-rerun]\n\
Usage: blk_mem_ram.sh [-reset_run]\n\
Usage: blk_mem_ram.sh [-clean]\n\
