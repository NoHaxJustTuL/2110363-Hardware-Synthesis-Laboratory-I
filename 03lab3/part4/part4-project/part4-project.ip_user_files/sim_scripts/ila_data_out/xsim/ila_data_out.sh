...
#
# Script generated by Vivado on Tue Jan 27 09:14:55 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_data_out.sh
...
#
# Usage        : ila_data_out.sh
#                ila_data_out.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_data_out.sh [-rerun]
#                ila_data_out.sh [-reset_run]
#                ila_data_out.sh [-clean]
#                ila_data_out.sh [-reset_log]
#                ila_data_out.sh [-help]
#
...
# script info
echo -e "ila_data_out.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_data_out.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_data_out xil_defaultlib.ila_data_out xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_data_out -key {Behavioral:sim_1:Functional:ila_data_out} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_data_out.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_data_out.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_data_out.sh [-help]\n\
Usage: ila_data_out.sh [-step]\n\
Usage: ila_data_out.sh [-lib_map_path]\n\
Usage: ila_data_out.sh [-rerun]\n\
Usage: ila_data_out.sh [-reset_run]\n\
Usage: ila_data_out.sh [-clean]\n\
Usage: ila_data_out.sh [-reset_log]\n\
Usage: ila_data_out.sh [-keep_index]\n\
Usage: ila_data_out.sh [-noclean_files]\n\n\
