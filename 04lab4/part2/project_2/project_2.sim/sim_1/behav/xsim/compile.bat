...
REM
REM Generated by Vivado on Mon Feb 02 22:03:31 +0700 2026
...
echo "xvlog --incr --relax -prj ram_wrapper_tb_vlog.prj"
call xvlog  --incr --relax -prj ram_wrapper_tb_vlog.prj -log xvlog.log
