...
#
# Script generated by Vivado on Tue Jan 27 09:22:59 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vio_data_generator_conf.sh
...
#
# Usage        : vio_data_generator_conf.sh
#                vio_data_generator_conf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_data_generator_conf.sh [-rerun]
#                vio_data_generator_conf.sh [-reset_run]
#                vio_data_generator_conf.sh [-clean]
#                vio_data_generator_conf.sh [-reset_log]
#                vio_data_generator_conf.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx/2025.2/Vivado/data"
...
# script info
echo -e "vio_data_generator_conf.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_data_generator_conf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_data_generator_conf xil_defaultlib.vio_data_generator_conf xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vio_data_generator_conf -key {Behavioral:sim_1:Functional:vio_data_generator_conf} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vio_data_generator_conf.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_data_generator_conf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_data_generator_conf.sh [-help]\n\
Usage: vio_data_generator_conf.sh [-step]\n\
Usage: vio_data_generator_conf.sh [-lib_map_path]\n\
Usage: vio_data_generator_conf.sh [-rerun]\n\
Usage: vio_data_generator_conf.sh [-reset_run]\n\
Usage: vio_data_generator_conf.sh [-clean]\n\
Usage: vio_data_generator_conf.sh [-reset_log]\n\
Usage: vio_data_generator_conf.sh [-keep_index]\n\
Usage: vio_data_generator_conf.sh [-noclean_files]\n\n\
